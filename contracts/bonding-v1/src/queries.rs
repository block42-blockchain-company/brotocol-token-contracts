...
use services::bonding::{ConfigResponse, StateResponse, ClaimsResponse, ClaimInfoResponse};

use crate::state::{load_config, load_state, load_claims};
...
pub fn query_config(deps: Deps) -> StdResult<ConfigResponse> {
    ...
    let resp = ConfigResponse {
        ...
        treasury_contract: deps.api.addr_humanize(&config.treasury_contract)?.to_string(),
